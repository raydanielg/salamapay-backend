...
<aside id="sidebar" class="sidebar" aria-label="Sidenav">
  ...
  <div class="sidebar-nav-container">
      <ul class="sidebar-menu-list">
          ...
          <li>
              <button type="button" class="sidebar-dropdown-btn" onclick="toggleDropdown('dropdown-payments')">
              ...
              <ul id="dropdown-payments" class="sidebar-dropdown-list">
                  <li><a href="#" class="sidebar-dropdown-item">All Payments</a></li>
                  <li><a href="#" class="sidebar-dropdown-item">Refunds</a></li>
              </ul>
          </li>
          <li>
              <button type="button" class="sidebar-dropdown-btn" onclick="toggleDropdown('dropdown-checkout')">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap">Checkout</span>
                  <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </button>
              <ul id="dropdown-checkout" class="sidebar-dropdown-list">
                  <li><a href="#" class="sidebar-dropdown-item">Sessions</a></li>
                  <li><a href="#" class="sidebar-dropdown-item">Settings</a></li>
              </ul>
          </li>
          <li>
              <a href="#" class="sidebar-item-link">
                  <svg aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z"></path><path d="M3 5a2 2 0 012-2h1a1 1 0 010 2H5v7h2l1 2h4l1-2h2V5h-1a1 1 0 110-2h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path></svg>
                  <span class="flex-1 ml-3 whitespace-nowrap">Messages</span>
                  <span class="badge-pill">6</span>
              </a>
          </li>
          <li>
              <button type="button" class="sidebar-dropdown-btn" onclick="toggleDropdown('dropdown-settings')">
                  <svg aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
                  <span class="flex-1 ml-3 text-left whitespace-nowrap">Settings</span>
                  <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </button>
              <ul id="dropdown-settings" class="sidebar-dropdown-list">
                  <li><a href="{{ route('tyro-dashboard.profile') }}" class="sidebar-dropdown-item">My Profile</a></li>
                  <li><a href="#" class="sidebar-dropdown-item">Business Profile</a></li>
              </ul>
          </li>
      </ul>
      <ul class="sidebar-menu-list mt-5 pt-5 border-t border-gray-200">
          <li>
              <a href="#" class="sidebar-item-link">
                  <svg aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path><path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path></svg>
                  <span class="ml-3">Docs</span>
              </a>
          </li>
          <li>
              <a href="#" class="sidebar-item-link">
                  <svg aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-2 0c0 .993-.241 1.929-.668 2.754l-1.524-1.525a3.997 3.997 0 00.078-2.183l1.562-1.562C15.802 8.249 16 9.1 16 10zm-5.165 3.913l1.58 1.58A5.98 5.98 0 0110 16a5.976 5.976 0 01-2.516-.552l1.562-1.562a4.006 4.006 0 001.789.027zm-4.677-2.796a4.002 4.002 0 01-.041-2.08l-.08.08-1.53-1.533A5.98 5.98 0 004 10c0 .954.223 1.856.619 2.657l1.54-1.54zm1.088-6.45A5.974 5.974 0 0110 4c.954 0 1.856.223 2.657.619l-1.54 1.54a4.002 4.002 0 00-2.346.033L7.246 4.668zM12 10a2 2 0 11-4 0 2 2 0 014 0z" clip-rule="evenodd"></path></svg>
  ...
  <div class="sidebar-footer-actions">
    ...
    <a href="{{ route('tyro-dashboard.profile') }}" class="sidebar-footer-btn">
