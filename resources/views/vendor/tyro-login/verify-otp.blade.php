    ...
    <div class="auth-grid">
        <div class="auth-left">
            <div class="form-card">
                ...
                <form method="POST" action="{{ route('tyro-login.otp.submit') }}" id="otp-form">
                    @csrf
        ...
        <div class="auth-right">
            <div class="promo-card">
                <div class="promo-title">Secure phone verification</div>
                <div class="promo-desc">Salamapay verifies your phone number to ensure your account and funds remain under your control.</div>

                <div class="promo-list">
                    <div class="promo-item">
                        <div class="promo-dot"></div>
                        <div>
                            <div class="promo-item-title">Anti-fraud protection</div>
                            <div class="promo-item-desc">Phone verification helps prevent unauthorized account access and protects your escrow payments.</div>
                        </div>
                    </div>
                </div>
            </div>
