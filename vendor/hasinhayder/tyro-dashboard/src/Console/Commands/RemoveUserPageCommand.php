...
class RemoveUserPageCommand extends Command
{
    /**
     * The name and signature of the console command.
     */
    protected $signature = 'tyro-dashboard:remove-user-page
                            {name? : The name of the page to remove}';

    /**
     * The console command description.
     */
    protected $description = 'Remove a user dashboard page';
    ...
    public function handle(): int
    {
        ...
        if (!$name) {
            $name = $this->ask('What is the name of the user page to remove?');
        ...
        $this->info('');
        $this->info('  ╔════════════════════════════════════════╗');
        $this->info('  ║    Removing User Dashboard Page        ║');
        $this->info('  ╚════════════════════════════════════════╝');
        $this->info('');
        ...
        $this->warn('     • Sidebar link from user-sidebar.blade.php');
        $this->info('');
    ...
    protected function removeRouteFromWebFile(string $pageName): void
    {
        ...
        // Pattern to match the route line
        $patterns = [
